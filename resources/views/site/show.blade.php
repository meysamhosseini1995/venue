                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="box-banner-activities-detail-4"> <img src="{{ $venue->image }}" alt="Travile">
                            <div class="container-banner-activities">
                                <div class="box-button-abs box-button-abs-right"> <a class="btn btn-brand-secondary" href="#">
                                        ...
                                        </svg>See All Photos</a><a class="btn-play popup-youtube" href="https://www.youtube.com/watch?v=JXMWOmuR1hU"> <img class="mr-0" src="assets/imgs/page/activities/btn-video.png" alt="Travila"></a></div>
                            </div>
                        </div>
                        ...
                        <div class="box-collapse-expand">
                                    ...
                                    <div class="card card-body">
                                        ...
                                        <div class="list-questions">
                                            <div class="item-question">
                                                <div class="head-question head-itinerary">
                                                    <p class="text-md-bold neutral-1000">Day 1: Arrival and Orientation</p>
                                                </div>
                                                <div class="content-question">
                                                    <div class="text-sm-medium neutral-800">
                                                        <ul>
                                            ...
                                            <div class="item-question active">
                                                <div class="head-question head-itinerary">
                                                    <p class="text-md-bold neutral-1000">Day 2: Exploring the Valleys</p>
                                                </div>
                                                <div class="content-question">
                                                    <div class="text-sm-medium neutral-800">
                                                        <ul>
                                            ...
                                            <div class="item-question">
                                                <div class="head-question head-itinerary">
                                                    <p class="text-md-bold neutral-1000">Day 3: Summit Adventure</p>
                                                </div>
                                                <div class="content-question">
                                                    <div class="text-sm-medium neutral-800">
                                                        <ul>
                                            ...
                                            <div class="item-question">
                                                <div class="head-question head-itinerary">
                                                    <p class="text-md-bold neutral-1000">Day 4: Waterfall Discovery</p>
                                                </div>
                                                <div class="content-question">
                                                    <div class="text-sm-medium neutral-800">
                                                        <ul>
                                            ...
                                            <div class="item-question">
                                                <div class="head-question head-itinerary">
                                                    <p class="text-md-bold neutral-1000">Day 5: Departure</p>
                                                </div>
                                                <div class="content-question">
                                                    <div class="text-sm-medium neutral-800">
                                                        <ul>
                            ...
                            <div class="group-collapse-expand">
                                <button class="btn btn-collapse" type="button" data-bs-toggle="collapse" data-bs-target="#collapseIncluded" aria-expanded="false" aria-controls="collapseIncluded">
